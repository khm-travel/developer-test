 ...
 *      Line 11: the submit button matches the value in index.html
 ...
 *      Optionally use a try catch block, and display error messages to the user when an exception occurs.
